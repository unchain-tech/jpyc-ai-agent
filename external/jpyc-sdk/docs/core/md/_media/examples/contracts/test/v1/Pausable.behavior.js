...
function shouldBehaveLikePausable(
  errorPrefix,
  pauser,
  owner,
  anotherAccount,
  ...
  describe('updatePauser', async function () {
    ...
    describe('when the newPauser is not the zero address', function () {
      ...
      describe('when the requested account is not owner (puser)', function () {
        it('reverts', async function () {
          await expectRevert(
            this.token.updatePauser(anotherAccount, { from: pauser }),
    ...
    describe('when the newBlocklister is the zero address', function () {
      it('reverts', async function () {
        await expectRevert(
          this.token.updatePauser(ZERO_ADDRESS, { from: owner }),
  ...
  describe('pausable token', function () {
    describe('approve', function () {
      it('allows to approve when unpaused', async function () {
        ...
        expect(await this.token.allowance(initialHolder, recipient)).to.be.bignumber.equal(
          initialSupply,
        );
      });
      ...
      it('reverts when trying to transfer when paused', async function () {
        ...
        await expectRevert(
          this.token.approve(recipient, initialSupply, { from: initialHolder }),
          `${errorPrefix}: paused`,
        );
      });
    });
    ...
    describe('transfer', function () {
      ...
      it('reverts when trying to transfer when paused', async function () {
        ...
        await expectRevert(
          this.token.transfer(recipient, initialSupply, { from: initialHolder }),
          `${errorPrefix}: paused`,
        );
      });
    });
    ...
    describe('transfer from', function () {
      ...
      it('allows to transfer from when unpaused', async function () {
        await this.token.transferFrom(initialHolder, recipient, allowance, {
          from: anotherAccount,
        });
      ...
      it('reverts when trying to transfer from when paused', async function () {
        ...
        await expectRevert(
          this.token.transferFrom(initialHolder, recipient, allowance, { from: anotherAccount }),
          `${errorPrefix}: paused`,
        );
      });
    });
    ...
    describe('mint', function () {
      ...
      it('reverts when trying to mint when pausd', async function () {
        ...
        await expectRevert(this.token.mint(to, value, { from: minter }), `${errorPrefix}: paused`);
      });
    });
    ...
    describe('configureMinter', function () {
      ...
      it('reverts when trying to configureMinter when pausd', async function () {
        ...
        await expectRevert(
          this.token.configureMinter(minter, value, { from: minterAdmin }),
          `${errorPrefix}: paused`,
        );
      });
    });
    ...
    describe('burn', function () {
      ...
      it('reverts when trying to burn when minter is paused', async function () {
        ...
        await expectRevert(this.token.burn(value, { from: minter }), `${errorPrefix}: paused`);
      });
    });
  });
}
