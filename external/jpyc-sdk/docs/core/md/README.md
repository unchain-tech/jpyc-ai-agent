...
This package implements NodeJS interface for interacting with the [JPYC contracts](https://github.com/jcam1/JPYCv2) on any supported chain. => 日本語版は[こちら](_media/README-jp.md)。
