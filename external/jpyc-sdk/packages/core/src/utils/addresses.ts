...
import { AddressString, ContractType, JpycSdkEnv, OptAddressString } from './types';

/** Zero address. */
export const ZERO_ADDRESS: AddressString = '0x0000000000000000000000000000000000000000';

/** Proxy address of JPYC contract. */
const JPYC_PROXY_ADDRESS: AddressString = '0xE7C3D8C9a439feDe00D2600032D5dB0Be71C3c29';
