...
describe("Unit tests of 'useMint' hook", () => {
  ...
  test('tx succeeds w/o any errors', async () => {
    ...
    expect(result.current.mint).toBeDefined();
    ...
    expect(simulateContract).toHaveBeenCalledWith(
      {},
      {
        ...
        functionName: 'mint',
        args: [to, 10000000000000000000000n],
        account: userAddress,
      },
    );
  ...
  test('hook not ready: `contractAbi` undefined', async () => {
    ...
    expect(result.current.mint).toBeUndefined();
