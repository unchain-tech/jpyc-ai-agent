...
describe("Unit tests of 'usePermit' hook", () => {
  ...
  test('tx succeeds w/o any errors', async () => {
    ...
    const value = 10000;
    const deadline = Uint256.from('3600');
    ...
    const { result, rerender } = renderHook(() => usePermit());

    expect(result.current.permit).toBeDefined();
    ...
    expect(simulateContract).toHaveBeenCalledWith(
      {},
      {
        ...
        functionName: 'permit',
        args: [owner, spender, 10000000000000000000000n, deadline, v, r, s],
        account: userAddress,
      },
    );
  ...
  test('hook not ready: `contractAbi` undefined', async () => {
    ...
    expect(result.current.permit).toBeUndefined();
