...
import { useReceiveWithAuthorization } from './useReceiveWithAuthorization';
...
describe("Unit tests of 'useReceiveWithAuthorization' hook", () => {
  ...
  test('tx succeeds w/o any errors', async () => {
    ...
    (useWriteContract as Mock)
      ...
      .mockReturnValueOnce({
        // right after calling `receiveWithAuthorization`
        data: txHash,
        isPending: true,
        error: writeError,
        writeContract,
    ...
    const { result, rerender } = renderHook(() => useReceiveWithAuthorization());

    expect(result.current.receiveWithAuthorization).toBeDefined();
    ...
    await act(async () => {
      await result.current.receiveWithAuthorization!({
        from,
        to,
        value,
        validAfter,
  ...
  test('tx simulation fails', async () => {
    ...
    const { result } = renderHook(() => useReceiveWithAuthorization());
  ...
  test('hook not ready: `contractAbi` undefined', async () => {
    ...
    expect(result.current.receiveWithAuthorization).toBeUndefined();
