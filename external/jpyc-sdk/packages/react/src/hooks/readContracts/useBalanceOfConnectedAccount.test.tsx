...
import { useBalanceOfConnectedAccount } from './useBalanceOfConnectedAccount';
...
describe("Unit tests of 'useBalanceOfConnectedAccount' hook", () => {
  ...
  test('success: skip = false & balanceOf = 10000', () => {
    ...
    const { result } = renderHook(() => useBalanceOfConnectedAccount({}));
  ...
  test('success: skip = true', () => {
    ...
    const { result } = renderHook(() => useBalanceOfConnectedAccount({ skip }));
